...
EXPECTED_WORKFLOW_SHA256 = "c8292162d585a9033cff4bd70070f13da792000dddb1511dd7389942eb35619c"
SAMPLES = (
    "background_switcher",
    "basic-note-taker",
    "facebook-login",
...
V12_TRUST_TEST = ROOT / "Tests/test_v12_external_trust_contract.py"
...
AUDITED_FILE_SHA256 = {
    ...
    V12_TRUST_TEST: "e41aeb662a40048c210159d02e50aa3296f8b3487fafa84b7188c5d20f3fd63a",
...
def hygiene_checks():
    ...
    if hashlib.sha256(workflow.encode("utf-8")).hexdigest() != EXPECTED_WORKFLOW_SHA256:
        errors.append("GitHub Actions workflow must match the reviewed externally sealed verification contract")
    ...
    for contract in (
        ...
        "trusted oracle must be outside the candidate checkout",
        "trusted manifest must be outside the candidate checkout",
